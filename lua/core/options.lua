...
o = vim.o
o.relativenumber = false -- Set relative numbered lines (default: false)
...
o.shiftwidth = 4 -- The number of spaces inserted for each indentation (default: 8)
o.tabstop = 4 -- Insert n spaces for a tab (default: 8)
o.softtabstop = 4 -- Number of spaces that a tab counts for while performing editing operations (default: 0)
...
o.showmode = true -- We don't need to see things like -- INSERT -- anymore (default: true)
...
o.cmdheight = 0 -- More space in the Neovim command line for displaying messages (default: 1)
